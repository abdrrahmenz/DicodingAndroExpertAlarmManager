package id.co.qodr.androexpertalarmmanager;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button btnOneTimeDate, btnOneTimeTime, btnOneTime, btnRepeatingTime, btnRepeating, btnCancelRepeating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(alarmPreference.getOneTimeDate())){
            setOneTimeText();
        } else if (!TextUtils.isEmpty(alarmPreference.getRepeatingTime())){
            setRepeatingText();
        }
    }
        ...
        if (view.getId() == R.id.btn_one_time_alarm_date){
            ...
            new TimePickerDialog(this, new TimePickerDialog.OnTimeSetListener() {
                ...
                public void onTimeSet(TimePicker timePicker, int hourOfDay, int minutes) {
                    ...
                    calOneTimeTime.set(Calendar.MINUTE, minutes);
            ...
            }, currentDate.HOUR_OF_DAY, currentDate.MINUTE, true).show();
